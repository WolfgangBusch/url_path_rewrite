...
<ul>
    ...
    <li>'.$urlbez.' eines Artikels [<code>'.REWRITER_URL.'</code>]:
        Wird in jedem Kontextmenüs des Artikels automatsch neu
        erzeugt, ist also auch vor der Eingabe von Artikelinhalten
        schon vorhanden. Dabei wird auch überprüft, ob das Paar
...
<ul>
    ...
    <li>Mit dem Eintritt in das Kontextmenü eines Artikels dieser
        Kategorie wird der '.$vname.' im Elternartikel übernommen,
        und zwar für alle Sprachversionen.</li>
</ul>
...
<ul>
    ...
    <li>Der zugehörige '.$urlbez.' [<code>'.REWRITER_URL.'</code>] wird
        durch Wechsel in ein anderes Kontextmenü des Artikels (z.B.
        durch Rückkehr in den Editiermodus) automatisch erzeugt,
        und zwar für alle Sprachversionen.</li>
</ul>
